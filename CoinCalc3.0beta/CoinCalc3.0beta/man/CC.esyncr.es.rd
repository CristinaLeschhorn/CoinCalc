...
\title{
Function: Event Synchronisation Rates for varying tau for two event sequences 
}
\description{
This function calculates the event synchronisation rates using two data sets of event sequence format (es) for different taus and the corresponding sigificance level.
}
\usage{
CC.esyncr.es(a, spana, b=a, spanb=spana, alpha=0.05, max_delT=min(spana[2],spanb[2]), sym=FALSE, offset=30, siglevel="TRUE", reps=1000)
}
