...
\title{
Function: Event Coincidence Rates for varying tau for two time series 
}
\description{
This function calculates the event coincidence rates using two data sets of event time series format (ts) for different taus and the corresponding sigificance level.
}
\usage{
CC.ecr.ts(seriesA, seriesB=seriesA, alpha=0.05, delT=0, sym=FALSE, offset=30, siglevel="TRUE",sigtest="shuffle.surrogate", reps=1000)
}
